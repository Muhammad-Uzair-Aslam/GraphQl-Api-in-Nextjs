...
const resolvers={
    ...
    Mutation:{
        createProducts:(root:{},args:{product:{}},context:{},info:{})=>{
            console.log("args",args.product)
            dummyProducts.push(args.product)
            return args.product
        },
        deleteProducts:(root:{},args:{id:Number},context:{},info:{})=>{
           dummyProducts=dummyProducts.filter((product)=>product.id !== args.id)
           console.log(dummyProducts)
           return "product is successfuly deleted"
        }
    }
